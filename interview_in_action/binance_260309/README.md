# 2026/03/09 Binance KYC Module Backend Interview
...
# 2026/03/17 Binance 1 hr 二面 (失敗)

幣安二面的面試官是一個外國人大概率是來自亞洲，全程要用英文溝通。流程分為上下兩階段大概是：

### Part-1. 30 mins

1. 用介紹一下經歷。
2. 為什麼一想加入 Binance？
2. 你在過往的專案中做過最自豪最有價值的項目是哪一個，並詳細介紹一下．
3. 在該專案中有使用哪些設計模式？起到什麼作用？
4. 有沒有使用過 SQL, NoSQL? 什麼情況下你會選擇怎樣的 Database。

### Part-2. 30 mins

5. Live Coding (不僅要完成，還需要說出時間空間複雜度)。
...
我覺得我其實並沒有真的很認真的在準備面試尤其是英文．Part-1 的問題，理論上應該在準備階段就要做到對答如流。這次會掛其實很正常，就是沒做準備．

我的英文問題就只是做到免強傳達意思．沒有辦法做到更深入的交流．

關於 Part - 1 優化計劃，我覺得平時的英文說寫練習就應該開始準備這些東西，並且要練到口語流暢．

<br>

Live Coding 的部分，是一道 Medium 的題目．validate sukudo 檢查．我算是壓線寫完．不過結束時面試官要求回答時空間複雜度．我大概說了兩個都是 O(n)。其實並不是很有把握．

關於這邊的優化，除了算法一樣要天天刷以外．還要開始了解自己解題的時空間複雜度．

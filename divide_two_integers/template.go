...
func Go() {
	common.Assert_answer(divide(100, 3), 33)
	common.Assert_answer(divide(10, 3), 3)
	common.Assert_answer(divide(-10, 3), -3)
	common.Assert_answer(divide(10, -3), -3)
	common.Assert_answer(divide(1000, 10), 100)
	common.Assert_answer(divide(100, 100), 1)
	common.Assert_answer(divide(100, 101), 0)
}

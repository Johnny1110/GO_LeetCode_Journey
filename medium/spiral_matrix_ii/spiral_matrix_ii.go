...
func generateMatrix(n int) [][]int {
	...
	for c.next() {
		...
		number += 1
		//fmt.Println("========================================================================")
		//fmt.Println("direction:", c.direct)
		//fmt.Println("current row:", c.currentRow, "current col:", c.currentCol)
		//fmt.Println("current matrix:", matrix)
		//fmt.Println("current top boundary:", c.topBoundary, "current bottom boundary:", c.bottomBoundary, "current left boundary:", c.leftBoundary, "current right boundary:", c.rightBoundary)

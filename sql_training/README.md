...
- [ ] **LC 586. Customer Placing the Largest Number of Orders** — GROUP BY + ORDER BY + LIMIT -> [link](customer_placing_the_largest_number_of_orders/README.md)
...
- [ ] **LC 176. Second Highest Salary** — 子查詢 + LIMIT OFFSET / IFNULL 處理邊界
